...
class DropdownComponentProps(BaseModel):
    ...
    target_url: Optional[str] = Field(None, description="URL to fetch dropdown options from")
    placeholder: Optional[str] = Field(None, description="Placeholder text for the dropdown")
    value: Optional[str] = Field(None, description="Initial value for the dropdown")
    disabled: bool = Field(False, description="Whether the dropdown is disabled")